...
TUTOR_ROUTES.get(
  "/tutor/market-place/classified",
  verifyToken,
  get_student_published_ads
);
TUTOR_ROUTES.post(
  "/tutor/market-place/shortlist",
  parser,
  verifyToken,
  ad_to_shortlist
);
...
TUTOR_ROUTES.delete(
  "/tutor/:tutorId/market-place/shortlist/:Id",
  verifyToken,
  delete_ad_from_shortlist
);
